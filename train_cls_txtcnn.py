...
parser.add_argument('--csvdir',default='/Users/duanyiqun/Downloads/Textcls/wp_analysis.csv', type=str, help='for ICO white paper list')
parser.add_argument('--article_dir',default='/Users/duanyiqun/Downloads/Textcls/txt', type=str, help='index direction for save')
